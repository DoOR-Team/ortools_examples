...
# AddAllowedAssignments(variables, tuples_list)
# variables 是一个list，里面若干变量
# tuples是一个list，里面每个元素是一个长度=len(variables)的list
# variables的所有取值，只能在tuples里取
# 如
# model.AddAllowedAssignments([x1, x2], [[0,0], [1,1]])
# 要么x1=x2=0,要么x1=x2=1
...
def main():
    ...
    model.AddAllowedAssignments([var1, var2], [[0,0],[1,1]])
